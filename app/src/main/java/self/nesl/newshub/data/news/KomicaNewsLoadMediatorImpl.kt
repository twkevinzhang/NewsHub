...
class KomicaNewsLoadMediatorImpl @Inject constructor(
    ...
    override suspend fun getEndOfPaginationReachedAfterLoad(loadType: LoadType, page: Int, topicNavItems: TopicNavItems): Boolean {
